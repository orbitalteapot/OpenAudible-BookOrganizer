...
def organize_audio(source_folder, csv_folder, destination_folder):
    books = load_books(os.path.join(csv_folder, 'books.csv'))
...
try:
    organize_audio("/source", "/csvexport", "/destination")
